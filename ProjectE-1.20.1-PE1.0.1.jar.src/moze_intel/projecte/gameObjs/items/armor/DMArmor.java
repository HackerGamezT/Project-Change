...
/*    */ 
/*    */ public class DMArmor
/*    */   extends PEArmor {
/*    */   public DMArmor(ArmorItem.Type armorPiece, Item.Properties props) {
/* 17 */     super(DMArmorMaterial.INSTANCE, armorPiece, props);
/*    */   }
/*    */ 
/*    */   
...
/* 31 */       return 5.0F / getPieceEffectiveness(type); 
/* 32 */     if (type == ArmorItem.Type.HELMET && source.m_269533_(DamageTypeTags.f_268581_)) {
/* 33 */       return 5.0F / getPieceEffectiveness(type);
/*    */     }
...
/*    */   }
/*    */   
/*    */   private static class DMArmorMaterial
...
/*    */       // Byte code:
/*    */       //   0: getstatic moze_intel/projecte/gameObjs/items/armor/DMArmor$1.$SwitchMap$net$minecraft$world$item$ArmorItem$Type : [I
/*    */       //   3: aload_1
...
/*    */       //   0	64	0	this	Lmoze_intel/projecte/gameObjs/items/armor/DMArmor$DMArmorMaterial;
...
/* Location:              C:\Users\Brent\Downloads\ProjectE-1.20.1-PE1.0.1.jar!\moze_intel\projecte\gameObjs\items\armor\DMArmor.class
